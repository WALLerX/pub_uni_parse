    ...
    return new Promise(async (res, rej) => {
      ...
      try {
        ...
        if(ad_not_public == 'Данное объявление больше не актуально.') {
          ...
          let list_about_house: any; try { list_about_house = (ad_e2e)?await page.$$eval('ul[data-e2e-id="-список"] > li > span:nth-child(1)', el => el.map(e => e.innerHTML.replace(/&nbsp;/g,'').trim())):''; } catch { list_about_house = []; }
          let house_material: string; try { house_material = (ad_e2e)?(list_about_house.indexOf('Материал стен') > -1)?(await page.$$eval('ul[data-e2e-id="-список"] > li > span:nth-child(3)', el => el.map(e => e.innerHTML)))[list_about_house.indexOf('Материал стен')]:'':await page.$eval('span[data-test-id="wallTypeValue"]', e => e.innerHTML); } catch { house_material = ''; }
          let floors_count: string; try { floors_count = (ad_e2e)?(list_about_house.indexOf('Количество этажей') > -1)?(await page.$$eval('ul[data-e2e-id="-список"] > li > span:nth-child(3)', el => el.map(e => e.innerHTML)))[list_about_house.indexOf('Количество этажей')]:'':''; } catch { floors_count = ''; }
          ...
          let list_about: any; try { list_about = (ad_e2e)?await page.$$eval('ul[data-e2e-id="Квартира-список"] > li > span:nth-child(1)', el => el.map(e => e.innerHTML.replace(/&nbsp;/g,''))):await page.$$eval('span[class="sc_flatInfoList_rowLabel"]', el => el.map(e => e.innerHTML.replace(/&nbsp;/g,''))); } catch { list_about = []; }
          let number_of_living_rooms = (ad_e2e)?(list_about.indexOf('Комнат') > -1)?(await page.$$eval('ul[data-e2e-id="Квартира-список"] > li > span:nth-child(3)', el => el.map(e => e.innerHTML)))[list_about.indexOf('Комнат')]:'':(list_about.indexOf('Комнаты') > -1)?(await page.$$eval('span[class="sc_flatInfoList_rowValue"]', el => el.map(e => e.innerHTML)))[list_about.indexOf('Комнаты')]:'';
          let floor = (ad_e2e)?(list_about.indexOf('Этаж') > -1)?(await page.$$eval('ul[data-e2e-id="Квартира-список"] > li > span:nth-child(3)', el => el.map(e => e.innerHTML)))[list_about.indexOf('Этаж')]:'':(list_about.indexOf('Этаж') > -1)?(await page.$$eval('span[class="sc_flatInfoList_rowValue"]', el => el.map(e => e.innerHTML)))[list_about.indexOf('Этаж')]:'';
          const total_area = (ad_e2e)?(list_about.indexOf('Площадь') > -1)?(await page.$$eval('ul[data-e2e-id="Квартира-список"] > li > span:nth-child(3)', el => el.map(e => e.innerHTML)))[list_about.indexOf('Площадь')].replace(/\sм²/,'').replace(/,/,'.').replace(/<span>([\d\.]+).*/,'$1'):'':(list_about.indexOf('Общая площадь') > -1)?(await page.$$eval('span[class="sc_flatInfoList_rowValue"]', el => el.map(e => e.innerHTML)))[list_about.indexOf('Общая площадь')].replace(/\sм²/,'').replace(/,/,'.'):'';
          const living_space = (ad_e2e)?(list_about.indexOf('Жилая') > -1)?(await page.$$eval('ul[data-e2e-id="Квартира-список"] > li > span:nth-child(3)', el => el.map(e => e.innerHTML)))[list_about.indexOf('Жилая')].replace(/\sм²/,'').replace(/,/,'.').replace(/<span>([\d\.]+).*/,'$1'):'':(list_about.indexOf('Жилая площадь') > -1)?(await page.$$eval('span[class="sc_flatInfoList_rowValue"]', el => el.map(e => e.innerHTML)))[list_about.indexOf('Жилая площадь')].replace(/\sм²/,'').replace(/,/,'.'):'';
          const kitchen_area = (ad_e2e)?(list_about.indexOf('Кухня') > -1)?(await page.$$eval('ul[data-e2e-id="Квартира-список"] > li > span:nth-child(3)', el => el.map(e => e.innerHTML)))[list_about.indexOf('Кухня')].replace(/\sм²/,'').replace(/,/,'.').replace(/<span>([\d\.]+).*/,'$1'):'':(list_about.indexOf('Площадь кухни') > -1)?(await page.$$eval('span[class="sc_flatInfoList_rowValue"]', el => el.map(e => e.innerHTML)))[list_about.indexOf('Площадь кухни')].replace(/\sм²/,'').replace(/,/,'.'):'';
          const finish_type  = (ad_e2e)?(list_about.indexOf('Ремонт') > -1)?(await page.$$eval('ul[data-e2e-id="Квартира-список"] > li > span:nth-child(3)', el => el.map(e => e.innerHTML)))[list_about.indexOf('Ремонт')]:'':(list_about.indexOf('Отделка') > -1)?(await page.$$eval('span[class="sc_flatInfoList_rowValue"]', el => el.map(e => e.innerHTML)))[list_about.indexOf('Отделка')]:'';
